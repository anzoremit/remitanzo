...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Remitanzocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"remitanzocoin.com", "167.88.3.68"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"remitanzocoin.com", "testnet-seed.remitanzocoin.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Remitanzocoin is probably already running."), addrBind.ToString().c_str());
        else
